...
@section('breadcrumb')
<li>
    <a href="{{ URL::to('kategori/kategoriekle') }}">Kategori Ekle</a>
</li>
@stop
@section('alttitle')
<h1 id="main-heading">
    Kategori Ekle <span>Bu Kısımdan Sisteme Kategori Ekleyebilirsiniz</span>
</h1>
@stop
@section('content')
<div class="row-fluid">
    <div class="span12">
        <div class="widget">
            ...
            <div class="widget-content form-container">
                <form class="form-horizontal validate" action="{{ URL::to('kategori/kategoriekle') }}" method="post">
                    <div class="control-group">
                        <label class="control-label" for="input00">Kategori Adı <span class="required">*</span></label>
                        <div class="controls">
                            <input name="kategoriadi" type="text" id="input00" class="span12" required>
                        </div>
                    </div>
