...
<html lang="en">
  <head>
    ...
    <title>TEZEL ET MAKİNALARI</title>

    <!-- Bootstrap core CSS -->
    <link href="{{ URL::to('Frontend/docs/dist/css/bootstrap.min.css') }}" rel="stylesheet">
    
    <!-- Custom styles for this template -->
    <link href="{{ URL::to('Frontend/docs/carousel.css') }}" rel="stylesheet">
  ...
  <body>
    <div class="navbar-wrapper">
      @include('Frontend.layoutt.header')
    </div>

@include('Frontend.layoutt.slidebar')
    <!-- Carousel
    ================================================== -->
...
@include('Frontend.layoutt.footer')
